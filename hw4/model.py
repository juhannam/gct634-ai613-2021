...
class PopMusicTransformer(object):
    ...
    # finetune
    ########################################
    def finetune(self, training_data, output_checkpoint_folder,Epoch_n=200):
        # shuffle
        ...
        if len(training_data) < self.batch_size:
            "The number of train samples is too small."
        ...
        for e in range(Epoch_n):
            ...
            self.saver.save(self.sess, '{}/model'.format(output_checkpoint_folder))
            # stop
